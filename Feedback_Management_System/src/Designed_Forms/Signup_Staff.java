...
public class Signup_Staff extends javax.swing.JFrame {
     ...
     */
    public Signup_Staff() {
        super("Staff Signup | FEEDBACK MANAGEMENT SYSTEM");
        initComponents();
    }
    ...
    public void adminSignupForm(){
        ...
        try{
            ...
            String sql = "INSERT INTO staff(Email, FirstName, LastName, Password, ConfirmPassword) VALUES (?,?,?,?,?)";
