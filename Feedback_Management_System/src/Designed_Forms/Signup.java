...
public class Signup extends javax.swing.JFrame {
     ...
     */
    public Signup() {
        super("Student Signup | FEEDBACK MANAGEMENT SYSTEM");
        initComponents();
    }
    /*Function_1: Student Signup*/
    public void studentSignupForm(){
        /*String,TextField,PassowrdField Variables*/
        String studentEmail = edtEmail.getText();
        String studentFirstName = edtFirstName.getText();
        String studentLastName = edtLastName.getText();
        String studentPassword = edtPassword.getText();
        String studentConfirmPassword = edtConfirmPassword.getText();
        ...
        try{
            ...
            String sql = "INSERT INTO student(Email, FirstName, LastName, Password, ConfirmPassword) VALUES (?,?,?,?,?)";
            ...
            ps.setString(5,studentConfirmPassword);
            
            /*Query Executing Statement*/
            
            int addedStudent = ps.executeUpdate();
            
            /*showing success or failure message*/
            if (addedStudent > 0){
                JOptionPane.showMessageDialog(this, "Account created successfully. Go to login page to login to your account.");
            }
            else{
    ...
    /*Function_2: Validation rules for all the fields*/
    public boolean signupValidation(){
        ...
        if(studentEmail.equals("") || !studentEmail.matches("^.+@.+\\..+$")){
        ...
        if(studentConfirmPassword.equals("")){
            JOptionPane.showMessageDialog(this, "You must confirm your password.");
            return false;
        }
        if(!studentPassword.equals(studentConfirmPassword)){
    ...
    /*Function_3: Existing email address check.*/
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(117, 79, 254));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/System_Images/feedback_system_signup.jpg"))); // NOI18N
        ...
        jLabel3.setForeground(new java.awt.Color(117, 79, 254));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("SIGNUP | STUDENTS");
        ...
        btnSignUp.setBackground(new java.awt.Color(117, 79, 254));
        ...
        lblAdminSignUp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/System_Icons/admin__signup(16x16).png"))); // NOI18N
        lblAdminSignUp.setText("ADMIN SIGNUP");
    ...
    private void btnSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignUpActionPerformed
        ...
        /*Calling Function_1: Result after clicking on Signup button*/
        /**/
        studentSignupForm();
        }
